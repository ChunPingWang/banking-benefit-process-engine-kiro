...
class NodeResult {
    ...
    public NodeResult(boolean success, Object result, String errorMessage) {
...
class ExecutionContext {
    private final Object customerData;
    private final java.util.Map<String, Object> contextData;
    
    public ExecutionContext(Object customerData, java.util.Map<String, Object> contextData) {
        this.customerData = customerData;
        this.contextData = contextData != null ? java.util.Map.copyOf(contextData) : java.util.Map.of();
    }
